...
("light_sun", sokf_invisible, "light_sphere", "0", [
    ...
    [
        ...
        (prop_instance_get_scale, pos5, ":var_0"),
        (position_get_scale_x, ":var_1", pos5),
        (store_time_of_day, reg12),
        (try_begin),
            (is_between, reg12, 5, 20),
            (store_mul, ":var_2", 1000, ":var_1"),
            (store_mul, ":var_3", 965, ":var_1"),
            (store_mul, ":var_4", 900, ":var_1"),
        (else_try),
            (store_mul, ":var_2", 450, ":var_1"),
            (store_mul, ":var_3", 575, ":var_1"),
            (store_mul, ":var_4", 750, ":var_1"),
        (try_end),
        (val_div, ":var_2", 100),
        (val_div, ":var_3", 100),
        (val_div, ":var_4", 100),
        (set_current_color, ":var_2", ":var_3", ":var_4"),
...
("light", sokf_invisible, "light_sphere", "0", [
    ...
    [
        ...
        (prop_instance_get_scale, pos5, ":var_0"),
        (position_get_scale_x, ":var_1", pos5),
        (store_mul, ":var_2", 600, ":var_1"),
        (store_mul, ":var_3", 435, ":var_1"),
        (store_mul, ":var_4", 135, ":var_1"),
        (val_div, ":var_2", 100),
        (val_div, ":var_3", 100),
        (val_div, ":var_4", 100),
        (set_current_color, ":var_2", ":var_3", ":var_4"),
...
("light_red", sokf_invisible, "light_sphere", "0", [
    ...
    [
        ...
        (prop_instance_get_scale, pos5, ":var_0"),
        (position_get_scale_x, ":var_1", pos5),
        (store_mul, ":var_2", 340, ":var_1"),
        (store_mul, ":var_3", 200, ":var_1"),
        (store_mul, ":var_4", 60, ":var_1"),
        (val_div, ":var_2", 100),
        (val_div, ":var_3", 100),
        (val_div, ":var_4", 100),
        (set_current_color, ":var_2", ":var_3", ":var_4"),
...
("light_night", sokf_invisible, "light_sphere", "0", [
    ...
    [
        ...
        (prop_instance_get_scale, pos5, ":var_0"),
        (position_get_scale_x, ":var_1", pos5),
        (store_mul, ":var_2", 480, ":var_1"),
        (store_mul, ":var_3", 435, ":var_1"),
        (store_mul, ":var_4", 300, ":var_1"),
        (val_div, ":var_2", 100),
        (val_div, ":var_3", 100),
        (val_div, ":var_4", 100),
        (set_current_color, ":var_2", ":var_3", ":var_4"),
...
("catapult_destructible", sokf_show_hit_point_bar|sokf_destructible|sokf_moveable, "Catapult", "bo_Catapult", [
    ...
    [
        (store_trigger_param_1, ":var_0"),
        (scene_prop_set_hit_points, ":var_0", 1600),
    ...
    [
        ...
        (try_begin),
            ...
            (prop_instance_animate_to_position, ":var_0", 1, 300),
            (try_begin),
                (eq, "$g_round_ended", 0),
                (scene_prop_get_team, ":var_1", ":var_0"),
                (try_begin),
                    (eq, ":var_1", 0),
                    (assign, ":var_2", -1),
                (else_try),
                ...
                (try_begin),
                    ...
                    (call_script, "script_show_multiplayer_message", 15, ":var_3"),
                    (get_max_players, ":var_4"),
                    (try_for_range, ":var_5", 1, ":var_4"),
                        (player_is_active, ":var_5"),
                        (multiplayer_send_2_int_to_player, ":var_5", 68, 15, ":var_3"),
                    (try_end),
                    (val_add, "$g_number_of_targets_destroyed", 1),
                (else_try),
                    (store_mul, ":var_3", ":var_2", 9),
                    (call_script, "script_show_multiplayer_message", 15, ":var_3"),
                    (get_max_players, ":var_4"),
                    (try_for_range, ":var_5", 1, ":var_4"),
                        (player_is_active, ":var_5"),
            ...
            (try_for_range, ":var_5", 0, ":var_4"),
                ...
                (try_begin),
                    ...
                    (player_get_slot, ":var_7", ":var_5", 32),
                (else_try),
                    (player_get_slot, ":var_7", ":var_5", 33),
                (try_end),
                (val_add, ":var_6", ":var_7"),
            (try_end),
            (assign, ":var_8", 0),
            ...
            (try_begin),
                ...
                (assign, ":var_8", 1500),
            (try_end),
            (val_mul, ":var_8", "$g_multiplayer_battle_earnings_multiplier"),
            (val_div, ":var_8", 100),
            (get_max_players, ":var_4"),
            (try_for_range, ":var_5", 0, ":var_4"),
                (player_is_active, ":var_5"),
                ...
                (else_try),
                    (player_get_slot, ":var_7", ":var_5", 33),
                (try_end),
                (player_get_gold, ":var_9", ":var_5"),
                (val_mul, ":var_7", ":var_8"),
                (try_begin),
                    (ge, ":var_6", ":var_7"),
                    (gt, ":var_7", 0),
                    (store_div, ":var_10", ":var_7", ":var_6"),
                (else_try),
                    (assign, ":var_10", 0),
                (try_end),
                (val_add, ":var_9", ":var_10"),
                (player_set_gold, ":var_5", ":var_9", 15000),
            (try_end),
        (try_end),
    ...
    [
        ...
        (try_begin),
            (scene_prop_get_hit_points, ":var_2", ":var_0"),
            (val_sub, ":var_2", ":var_1"),
            (gt, ":var_2", 0),
        ...
        (try_begin),
            ...
            (position_get_x, ":var_3", pos2),
            (try_begin),
                (ge, ":var_3", 0),
                (agent_is_alive, ":var_3"),
                (agent_is_human, ":var_3"),
                (neg|agent_is_non_player, ":var_3"),
                (agent_get_player_id, ":var_4", ":var_3"),
                (ge, ":var_4", 0),
                (player_is_active, ":var_4"),
                (try_begin),
                    (eq, "spr_catapult_destructible", "$g_destructible_target_1"),
                    (player_get_slot, ":var_5", ":var_4", 32),
                    (val_add, ":var_5", ":var_1"),
                    (player_set_slot, ":var_4", 32, ":var_5"),
                (else_try),
                    (player_get_slot, ":var_5", ":var_4", 33),
                    (val_add, ":var_5", ":var_1"),
                    (player_set_slot, ":var_4", 33, ":var_5"),
                (try_end),
            (try_end),
        (try_end),
    ]),
...
("door_destructible", sokf_show_hit_point_bar|sokf_destructible|sokf_moveable|spr_use_time(2), "tutorial_door_a", "bo_tutorial_door_a", [
    ...
    [
        (store_trigger_param_1, ":var_0"),
        (store_trigger_param_2, ":var_1"),
        (call_script, "script_use_item", ":var_1", ":var_0"),
        (get_max_players, ":var_2"),
        (try_for_range, ":var_3", 1, ":var_2"),
            (player_is_active, ":var_3"),
            (multiplayer_send_2_int_to_player, ":var_3", 76, ":var_1", ":var_0"),
        (try_end),
    ]),    (ti_on_init_scene_prop,
    [
        (store_trigger_param_1, ":var_0"),
        (scene_prop_set_hit_points, ":var_0", 2000),
    ]),    (ti_on_scene_prop_destroy,
    [
        (play_sound, "snd_dummy_destroyed"),
        (assign, ":var_0", 86),
        (try_begin),
            ...
            (position_get_distance_to_ground_level, ":var_3", pos4),
            (val_sub, ":var_3", 100),
            (assign, ":var_4", ":var_3"),
            (val_div, ":var_4", 3),
            (try_begin),
            ...
            (else_try),
                (val_sub, ":var_0", ":var_4"),
            (try_end),
            (position_rotate_x, pos1, ":var_0"),
            (prop_instance_animate_to_position, ":var_1", 1, 70),
        (try_end),
    ]),    (ti_on_scene_prop_hit,
    [
        (play_sound, "snd_dummy_hit"),
...
("archery_butt_a", 0, "archery_butt", "bo_archery_butt", [
    ...
    [
        (store_trigger_param_1, ":var_0"),
        (prop_instance_get_position, pos2, ":var_0"),
        (get_player_agent_no, ":var_1"),
        (agent_get_position, pos3, ":var_1"),
        (get_distance_between_positions, ":var_2", pos3, pos2),
        ...
        (get_distance_between_positions, ":var_3", pos4, pos2),
        (assign, ":var_4", 43),
        (val_sub, ":var_4", ":var_3"),
        (val_mul, ":var_4", 1299),
        (val_div, ":var_4", 4300),
...
("archery_target_with_hit_a", 0, "arena_archery_target_a", "bo_arena_archery_target_a", [
    ...
    [
        (set_fixed_point_multiplier, 100),
        (store_trigger_param_1, ":var_0"),
        (position_get_x, ":var_1", pos2),
        (val_div, ":var_1", 100),
        (get_player_agent_no, ":var_2"),
        (try_begin),
            (eq, ":var_2", ":var_1"),
            (prop_instance_get_position, pos2, ":var_0"),
            (agent_get_position, pos3, ":var_2"),
            (get_distance_between_positions, ":var_3", pos3, pos2),
            (position_transform_position_to_local, pos4, pos2, pos1),
            (position_set_y, pos4, 0),
            (position_set_x, pos2, 0),
            (position_set_y, pos2, 0),
            (position_set_z, pos2, 0),
            (get_distance_between_positions, ":var_4", pos4, pos2),
            (assign, ":var_5", 43),
            (val_sub, ":var_5", ":var_4"),
            (val_mul, ":var_5", 1299),
            (val_div, ":var_5", 4300),
            (try_begin),
                ...
                (assign, ":var_5", 0),
            (try_end),
            (assign, "$g_last_archery_point_earned", ":var_5"),
            (val_div, ":var_3", 91),
            (assign, reg60, ":var_5"),
            (assign, reg61, ":var_3"),
            (display_message, "str_archery_target_hit"),
            ...
            (prop_instance_get_variation_id_2, ":var_6", ":var_0"),
            (val_sub, ":var_6", 1),
            (eq, "$g_tutorial_training_ground_current_score", ":var_6"),
...
("dummy_a", sokf_destructible|sokf_moveable, "arena_archery_target_b", "bo_arena_archery_target_b", [
    ...
    [
        (store_trigger_param_1, ":var_0"),
        (prop_instance_get_starting_position, pos1, ":var_0"),
        (get_player_agent_no, ":var_1"),
        ...
        (try_begin),
            ...
            (val_mul, ":var_2", -1),
        (try_end),
        (position_rotate_x, pos1, ":var_2"),
        (prop_instance_animate_to_position, ":var_0", 1, 70),
    ...
    [
        ...
        (try_begin),
            ...
            (val_mul, ":var_1", -1),
        (try_end),
        (position_rotate_x, pos2, ":var_1"),
        (display_message, "str_delivered_damage"),
        (prop_instance_animate_to_position, ":var_0", 2, 30),
        (play_sound, "snd_dummy_hit"),
        (particle_system_burst, "psys_dummy_smoke", pos1, 3),
        (particle_system_burst, "psys_dummy_straw", pos1, 10),
    ]),
...
("castle_f_door_a", sokf_show_hit_point_bar|sokf_destructible|sokf_moveable, "castle_f_door_a", "bo_castle_f_door_a", [
    ...
    [
        ...
        (prop_instance_get_starting_position, pos2, ":var_1"),
        (scene_prop_get_slot, ":var_2", ":var_1", 1),
        (try_begin),
            (ge, ":var_0", 0),
            ...
            (try_begin),
                ...
                (try_for_range, ":var_5", 1, ":var_4"),
                    (player_is_active, ":var_5"),
                    (multiplayer_send_2_int_to_player, ":var_5", 76, ":var_1", ":var_0"),
                (try_end),
            (try_end),
        (try_end),
    ]),    (ti_on_init_scene_prop,
    [
        (store_trigger_param_1, ":var_0"),
        (scene_prop_set_hit_points, ":var_0", 1000),
    ]),    (ti_on_scene_prop_destroy,
    [
        (play_sound, "snd_dummy_destroyed"),
        (assign, ":var_0", 86),
        ...
        (try_begin),
            ...
            (try_begin),
                ...
                (try_for_range, ":var_4", 1, ":var_3"),
                    (player_is_active, ":var_4"),
                    (multiplayer_send_2_int_to_player, ":var_4", 76, ":var_1", ":var_0"),
                (try_end),
            (try_end),
        (try_end),
    ]),    (ti_on_init_scene_prop,
...
("custom_banner_01", 0, "custom_banner_01", "0", [
    ...
    [
        ...
        (try_begin),
            (ge, ":var_0", 0),
            (cur_scene_prop_set_tableau_material, "tableau_custom_banner_default", ":var_0"),
        (try_end),
    ]),
]),
...
("castle_e_sally_door_a", sokf_show_hit_point_bar|sokf_destructible|sokf_moveable, "castle_e_sally_door_a", "bo_castle_e_sally_door_a", [
    ...
    [
        (store_trigger_param_1, ":var_0"),
        (scene_prop_set_hit_points, ":var_0", 3000),
    ]),    (ti_on_scene_prop_destroy,
    [
        (play_sound, "snd_dummy_destroyed"),
        (assign, ":var_0", 86),
...
("trebuchet_destructible", sokf_show_hit_point_bar|sokf_destructible|sokf_moveable, "trebuchet_new", "bo_trebuchet_old", [
    ...
    [
        (store_trigger_param_1, ":var_0"),
        (scene_prop_set_hit_points, ":var_0", 2400),
    ]),    (ti_on_scene_prop_destroy,
    [
        (play_sound, "snd_dummy_destroyed"),
        (try_begin),
...
("siege_ladder_move_6m", sokf_type_ladder|sokf_moveable|spr_use_time(2), "siege_ladder_move_6m", "bo_siege_ladder_move_6m", [
    ...
    [
        (store_trigger_param_1, ":var_0"),
        (store_trigger_param_2, ":var_1"),
        (call_script, "script_check_creating_ladder_dust_effect", ":var_0", ":var_1"),
    ]),    (ti_on_scene_prop_animation_finished,
    [
        (store_trigger_param_1, ":var_0"),
        (prop_instance_enable_physics, ":var_0", 1),
    ]),
]),
...
("gourd", sokf_destructible|sokf_moveable|sokf_enforce_shadows|spr_hit_points(1), "gourd", "bo_gourd", [
    ...
    [
        ...
        (prop_instance_animate_to_position, ":var_0", 2, 1),
...
("dummy_a_undestructable", sokf_destructible, "arena_archery_target_b", "bo_arena_archery_target_b", [
    ...
    [
        (store_trigger_param_1, ":var_0"),
        (scene_prop_set_hit_points, ":var_0", 10000000),
    ]),    (ti_on_scene_prop_hit,
    [
        (store_trigger_param_1, ":var_0"),
        (store_trigger_param_2, ":var_1"),
        (try_begin),
            ...
            (val_sub, ":var_4", 1),
            (eq, "$g_tutorial_training_ground_current_score", ":var_4"),
            (val_add, "$g_tutorial_training_ground_current_score", 1),
        (try_end),
        (play_sound, "snd_dummy_hit"),
        (particle_system_burst, "psys_dummy_smoke", pos1, 3),
...
("earth_sally_gate_left", sokf_show_hit_point_bar|sokf_destructible|sokf_moveable, "earth_sally_gate_left", "bo_earth_sally_gate_left", [
    ...
    [
        ...
        (scene_prop_get_slot, ":var_2", ":var_1", 1),
        (try_begin),
            (prop_instance_get_scene_prop_kind, ":var_3", ":var_1"),
            (assign, ":var_4", 0),
            (try_begin),
                (neg|eq, ":var_3", "spr_viking_keep_destroy_sally_door_right"),
                (neg|eq, ":var_3", "spr_viking_keep_destroy_sally_door_left"),
                (neg|eq, ":var_3", "spr_earth_sally_gate_right"),
                (neg|eq, ":var_3", "spr_earth_sally_gate_left"),
                (position_is_behind_position, pos1, pos2),
                (assign, ":var_4", 1),
            (else_try),
                (this_or_next|eq, ":var_3", "spr_viking_keep_destroy_sally_door_right"),
                (this_or_next|eq, ":var_3", "spr_viking_keep_destroy_sally_door_left"),
                (this_or_next|eq, ":var_3", "spr_earth_sally_gate_right"),
                (eq, ":var_3", "spr_earth_sally_gate_left"),
            ...
            (try_begin),
                ...
                (try_for_range, ":var_6", 1, ":var_5"),
                    ...
                    (multiplayer_send_2_int_to_player, ":var_6", 76, ":var_1", ":var_0"),
                (try_end),
            (try_end),
        (try_end),
    ]),    (ti_on_init_scene_prop,
